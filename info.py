...
API_ID = int(environ['API_ID', '21419016'])
API_HASH = environ['API_HASH', '79198e1eb4cfd0f771a89d83b9144e7e']
BOT_TOKEN = environ['BOT_TOKEN', '8337068928:AAFAvGMv0tTqDOMBFN8AKwuZc742WQMAKaw']
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003031740737').split()]
...
REQ_CHANNEL = environ.get("REQ_CHANNEL", '-1002949585963')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002772960825')).split()]
